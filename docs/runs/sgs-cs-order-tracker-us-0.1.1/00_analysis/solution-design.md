...
<!-- Generated: 2026-02-05 | Branch: feature/sgs-cs-order-tracker-us-0.1.1 -->
...
|------|----------------|---------|
| 1 | `pnpm create next-app@latest sgs-cs-order-tracker --typescript --tailwind --eslint --app --src-dir --import-alias "@/*"` | Scaffold project |
| 2 | `cd sgs-cs-order-tracker && pnpm dlx shadcn-ui@latest init` | Initialize shadcn/ui |
